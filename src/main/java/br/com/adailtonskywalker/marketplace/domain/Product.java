...
public class Product {
    ...
    public void gravar() throws IOException {
        ...
        linha = String.format("%-1s;%1.2f;%-1s;%-1s;%-1d;%-1s", this.getName(), this.getPrice(), this.getCodP(), this.getDescription(), this.getQStock(), this.getTypes());
